...
import EditEvidenceModal from "../../components/forms/edit-evidence-modal";
...
export default function EvidenceDetails() {
  ...
  const handleDownloadFile = () => {
    if (evidencia?.arquivo) {
      Alert.alert("Baixar Arquivo", "Deseja abrir o arquivo da evidência?", [
    ...
    <View style={{ flex: 1, backgroundColor: "#f5f5f5" }}>
      ...
      <ScrollView style={{ flex: 1 }} showsVerticalScrollIndicator={false}>
        ...
        <InfoSection title="Informações Básicas">
          <InfoRow icon="title" label="Título" value={evidencia.titulo} />
        ...
        <InfoSection title="Arquivo">
          <InfoRow
            ...
            value={
              evidencia.tipoArquivo?.charAt(0).toUpperCase() +
              evidencia.tipoArquivo?.slice(1)
            }
          />
        ...
        <InfoSection title="Metadados">
          ...
          <InfoRow icon="folder" label="ID do Caso" value={evidencia.caso} />
        </InfoSection>
