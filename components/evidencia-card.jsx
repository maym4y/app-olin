...
export default function ShowCard(props) {
  ...
  return (
    <View style={styles.caseCard}>
      ...
      <Text style={styles.lightText}>{item.localDaColeta}</Text>
      <Text style={styles.lightText}>{item.criadoPor.name}</Text>
      <View style={styles.cardBottom}>
        <Text style={styles.lightText}>{item.criadoEm.split('T')[0]}</Text>
